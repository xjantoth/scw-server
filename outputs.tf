...
output "server_scaleway_server_private_ip" {
  value       = module.server.this_scaleway_server_private_ip
  description = "Kubernetes server private ip"
}

output "server_scaleway_server_public_ip" {
  value       = module.server.this_scaleway_server_public_ip
